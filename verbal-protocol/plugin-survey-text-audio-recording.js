var jsPsychSurveyTextAudioRecording = (function (jspsych) {
  "use strict";

  const info = {
    name: "survey-text-audio-recording",
    parameters: {
      questions: {
  ...
  class SurveyTextAudioRecordingPlugin {
    constructor(jsPsych) {
    ...
    trial(display_element, trial) {
      ...
      display_element
        ...
        .addEventListener("submit", this.end_trial);
      ...
      if (trial.trial_duration !== null) {
        this.jsPsych.pluginAPI.setTimeout(() => {
          display_element.querySelector("#jspsych-survey-text-form");
  ...
  SurveyTextAudioRecordingPlugin.info = info;

  return SurveyTextAudioRecordingPlugin;
})(jsPsychModule);
